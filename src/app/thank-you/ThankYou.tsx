      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-base text-zinc-500">
            We received your order and wit will be delivered to you ASAP.
          </p>
        ...
        <div className="mt-10 border-t border-x-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              we at CasePenguin believe that a phone case does not only have to
              be beautiful but also last you for a long time. We offer a 5-year
              warranty on all of our cases: if your case is not of the best
              quality, we will replace it for you for free
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-700">
                Bosta, takes up to 5 working days
              </p>
            </div>
          </div>
        </div>
